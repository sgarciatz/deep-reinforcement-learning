...
class TrainLogger(object):
    ...
    def __init__(self,
        ...
        Args:
            output_path (Path): The directory where the training data is
            going to be stored.
            training_name (Path): The id of the training used to name the
            directory.
            experiment_info (dict): A summary of the training.
        """
