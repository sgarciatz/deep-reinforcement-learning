...
class ActionSelector(object):
    ...
    def __init__(self,
        ...
        self.decay_strategy: str = decay_strategy
        self.start_exploration_rate: float = start_exploration_rate
        self.end_exploration_rate: float = end_exploration_rate
    ...
    def decay_exploration_rate(self, current_step: int, training_steps: int) -> None:
        ...
        """
        current_step += 1
        training_ratio: float = current_step / training_steps
        if (self.decay_strategy == "linear"):
            ...
            exponent: float = -1 * training_ratio * math.e * self.decay_rate
            self.exploration_rate =\
